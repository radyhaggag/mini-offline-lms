...
/// Use case that searches courses by query and evaluates watch progress and unlock state.
class SearchCoursesUseCase {
  const SearchCoursesUseCase({
  ...
  Future<Result<List<Course>>> call(String query) async {
